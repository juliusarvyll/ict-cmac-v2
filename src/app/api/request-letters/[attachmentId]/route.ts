...
export async function GET(
  ...
  const isPmacHandoffManager = isPmacStaffingManagerRole(session.user.role) && !!attachment.request?.pmacEvent
  if (!isLeadership && !ownsAttachment && !ownsRequest && !isPmacHandoffManager) {
